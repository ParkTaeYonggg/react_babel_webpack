...
<img width="772" alt="스크린샷 2022-01-01 오후 7 59 02" src="https://user-images.githubusercontent.com/86910922/148692480-2171cc02-e466-4192-98c3-44da5ccd3492.png">

cors에러를 막기 위해 프록스를 설정해주었다. "/api/*" 부분과 url을 추가해주어 여러 곳의 프록시 개방도 가능하다. 

### historyApiFallback 설정

<img width="769" alt="스크린샷 2022-01-10 오전 2 03 25" src="https://user-images.githubusercontent.com/86910922/148692572-43dee315-01ca-4bc5-ad9e-eb81e0be1829.png">

이걸 설정해줌으로 퍼블릭패스 변경시 새로고침 하더라도 에러가 나지 않고 제대로 경로를 잡아준다.
